...
PhysicsServer::ShapeType Box3DPhysicsServer::shape_get_type(RID p_shape) const {
	return PhysicsServer::ShapeType();
}
...
PhysicsServer::AreaSpaceOverrideMode Box3DPhysicsServer::area_get_space_override_mode(RID p_area) const {
	return PhysicsServer::AreaSpaceOverrideMode();
}
...
Variant Box3DPhysicsServer::area_get_param(RID p_parea, PhysicsServer::AreaParameter p_param) const {
	return Variant();
}
